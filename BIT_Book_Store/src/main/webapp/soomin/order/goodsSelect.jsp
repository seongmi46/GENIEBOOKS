		...
		<div class="row">
			...
			<div class="col-sm-8 order_bar">
			  	<div class="align-left">
					...
					<img class="order-img" alt="결제이미지" src="${pageContext.request.contextPath}/resources/images/order/BuyBlackImage.png">
					...
					<c:forEach var="goodsvo" begin="<%= begin %>" items="${goodsList}" end="<%=end %>">
						<td class="center td-width">
							<img class="order-img" alt="${goodsvo.goods_name }" 
								src="${pageContext.request.contextPath}/resources/images/goods_img/${goodsvo.goods_image }">
						</td>
					</c:forEach>
...
%>
			...
			<br><br><br>
			<div class="align-left">
				<input type="button" class="btn btn-go-cart" value="장바구니 가기"/>
