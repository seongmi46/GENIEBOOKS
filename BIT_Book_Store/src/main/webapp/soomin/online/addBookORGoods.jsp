            ...
            <div class="card-body">
              ...
              <!-- 굿즈 데이터 전송 form -->
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tr>
                  	<td>굿즈판매시작일</td>
                  	<td><input type="date" class="form-control" name="book_published_date" placeholder="굿즈판매시작일을 입력하세요"></td>
                  </tr>
                  <tr>
                  	<td>판매종료일</td>
                  	<td><input type="date" class="form-control" name="book_published_date" placeholder="굿즈판매종료일을 입력하세요"></td>
                  </tr>
                  <tr>
                  	<td>이미지</td>
