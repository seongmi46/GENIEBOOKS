              ...
              <div class="table-responsive">
                ...
                <table class="table table-bordered" id="dataTable" style="width:100%, cellspacing:0">
                  ...
                  <c:forEach var="bookStockvo" items="${bookStockvoList }">
                  	<tr class="popupBookInfo">
                  		<td class="point">${bookStockvo.book_no }</td>
                  		<td class="point">${bookStockvo.category_no }</td>
                  		<td class="point"><!-- <a href="#bookInfo" data-toggle="modal"> -->
                  			${bookStockvo.book_name }<!-- </a> --></td>
                  		<td class="point">${bookStockvo.book_writer }</td>
                  		<td class="point">${bookStockvo.book_publisher }</td>
                  		<td class="point">${bookStockvo.book_price }</td>
                  		<td class="point">${bookStockvo.book_saleprice }</td>
					...
					<td colspan="4">
						<ol class="paging">
							...
							<c:otherwise>
								...
								<li><a href="productStock.do?cPage=${pvo.beginPage - 1}">이전</a></li>
							</c:otherwise>
							</c:choose>
							...
							<c:otherwise>
								<li>
									<a href="productStock.do?cPage=${pageNo }">${pageNo }</a>
								</li>
							</c:otherwise>
							</c:choose>
							</c:forEach>
							...
							<c:otherwise>
								<li><a href="productStock.do?cPage=${pvo.endPage + 1}">다음</a></li>
							</c:otherwise>
							</c:choose>
						</ol>
					</td>
