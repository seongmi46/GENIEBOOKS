            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tr>
                  	<td>EBOOK 여부</td>
                  	<td colspan="2"><input type="text" class="form-control" name="ebook" value="${bookInfo.ebook }"></td>
                  	<td></td>
                  </tr>
                  <tr>
                  	<td>ISBN</td>
                  	<td colspan="2"><input type="text" class="form-control" name="book_isbn" value="${bookInfo.book_isbn }"></td>
                  	<td></td>
                  </tr>
                  <tr>
                  	<td>이미지경로</td>
                  	<td colspan="2"><input type="text" class="form-control" name="book_img" value="${bookInfo.book_img }"></td>
                  	<td></td>
                  </tr>
                  <tr>
                  	<td colspan="4" class="centerAlign"><button type="button" class="btn btn-outline-primary">입고</button>
