...
$(document).ready(function(){
	...
	$("#ghmoonjego").click(function(){
		var ghmoonPop = window.open("../biz/view/ghmoonjego.jsp","pop1",
					...
					if(result == "성공!"){
						alert("선택한 상품이 장바구니에 담겼습니다.");
							if(confirm("장바구니로 이동하시겠습니까?")==true){//확인
								document.location.href="/biz/cart.jsp";
							}else{
								return false;
							}
       ...
       <!-- 부트:왼쪽 사이드바 -->
		...
		<table border id="mainExp">
				...
				<div id="storeContainer"><%--팝업창 div --%>
					...
					<table border style="border:1px solid gray; width:400px">
						...
						<c:forEach var="jegoOri" items="${jego}">
							<td><a href="javascript:window.open('view/ghmoonjego.jsp?
			...
			<table border><!-- 이벤트 -->
				...
				<tr class="eventP">
					<td><img src="/biz/resources/images/pic/event1.jpg" alt="이벤트사진"></td>
					<td>이벤트정보</td>
					<td><img src="/biz/resources/images/pic/event2.jpg" alt="이벤트사진"></td>
					<td>이벤트정보</td>
				</tr>
				<tr class="eventP">
