...
public class OfficeServiceImpl implements OfficeService{
	...
	//오늘 판매금액 출력
	@Override
	public int todaySalesValue(String store_code) {
		return officeDAO.todaySalesValue(store_code);
	}

	//월 판매금액 출력
	@Override
	public int monthSalesValue(String store_code) {
		return officeDAO.monthSalesValue(store_code);
	}
